...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E278C65934B");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B46CDFE189");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB859FCF3BFD");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229F6A3F50F");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4C2D7FFCE");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5948E64DD");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9CB52C68EC");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E61644A8095F9").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D30DD22F10");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30CAC8C442F");
